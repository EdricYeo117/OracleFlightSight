    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: 14, opacity: 0.9 }}>
          Click each glowing point {clicksPerPoint} times while looking directly at it
        </div>
